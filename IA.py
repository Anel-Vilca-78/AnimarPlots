...
def agregar():
    global intervaloInferior, intervaloSuperior, img_files, poblacionInicial, poblacionMaxima, poblacionActual, nResolucion, iteraciones, generacion, resolucion, puntos, rango, bits, Pmi, Pmg, n, k, g, poblacionCopia, iDecimalCopia, generaciones, mejorCaso, peorCaso, promedio, fxCopia, xCopia, hijos, copia, fx, x, poblacion, iDecimal
